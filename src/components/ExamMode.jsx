...
const EXAM_NAME = 'CIA Part 3 Exam Simulation';
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] lg:min-h-screen flex flex-col max-w-2xl mx-auto">
      ...
      <div className="flex-1 px-4 py-8 flex flex-col items-center justify-center">
        ...
        <h2 className="text-2xl font-bold mb-2 text-center">CIA Part 3 Exam Simulation</h2>
        ...
        <div className="w-full max-w-sm space-y-3 mb-8">
          {[
            { icon: '📋', label: `${EXAM_Q} Questions`, desc: 'Randomly drawn from all CIA Part 3 domains' },
        ...
        <p className="text-xs text-slate-500 mb-6 text-center">The IIA CIA Part 3 exam passing score is 600 on a 200–800 scale.</p>
        <button
          onClick={onStart}
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] lg:min-h-screen flex flex-col max-w-2xl mx-auto">
      ...
      <div className="px-4 py-5 border-b border-slate-800 text-center">
        <div className="text-5xl mb-2">{pct >= 75 ? '🏆' : '📚'}</div>
        <h2 className="text-4xl font-bold mb-1">
          <span className={pct >= 75 ? 'text-emerald-400' : 'text-red-400'}>{pct}%</span>
        </h2>
        <p className={`text-sm font-semibold mb-1 ${pct >= 75 ? 'text-emerald-300' : 'text-red-300'}`}>
          {pct >= 75 ? 'Excellent — on track to pass' : 'Keep studying — focus on weak areas'}
        </p>
